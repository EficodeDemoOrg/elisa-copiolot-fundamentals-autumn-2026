...
For these exercises, it's recommended to use **Auto** model mode and **Default permissions** instead of Autopilot. These settings can be enabled in the lower part of the Copilot chat panel.
